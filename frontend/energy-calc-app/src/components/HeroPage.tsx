        ...
        <div className="flex h-auto pt-[12vh]">
          <div className="w-full">
            ...
            <div className="mt-10 flex gap-10">
              <button className="bg-cta-blue py-5 px-10 rounded-3xl text-gray-100 text-xl font-semibold cursor-pointer">
                Get started
              </button>
              <button className="border-cta-blue border-3 py-5 px-10 rounded-3xl text-font-black text-xl font-semibold cursor-pointer">
                Learn more
              </button>
            </div>

            <div className="mt-15 flex text-center divide-gray-400 > * divide-x-2 > * text-2xl">
              <div className="pr-5 py-5">
                <h2 className="text-3xl font-bold">98.25%</h2>
                <p className="text-gray-500">Bill Prediction Rate</p>
              </div>
              <div className="p-5">
                <h2 className="text-3xl font-bold">97.94%</h2>
